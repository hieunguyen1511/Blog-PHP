...
@section('content')
                    ...
                    <div class="p-6 border-b border-gray-100">
                        ...
                        <div class="flex items-center space-x-4 text-sm text-gray-500">
                            ...
                            <div class="flex items-center">
                                ...
                                <a
                                    href="{{ route('category.post', ['link' => $post->category->link]) }}">{{ $post->category->name }}</a>
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-100">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                <button data-post-id="{{ $post->id }}" id="like-button"
                                    class="flex items-center  {{ $is_like ? 'text-blue-600' : 'text-gray-500' }}">
                                ...
                                <div class="flex space-x-4">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center mb-1">
                                            ...
                                            <span
                                                class="ml-2 text-sm text-gray-500">{{ $item->created_at->format('Y/m/d H:i') }}</span>
                                        </div>
                            ...
                            <div class="ml-4">
                                ...
                                <div class="flex items-center space-x-4 text-sm text-gray-500">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="like-count">{{ $post->user->posts->sum('like_count') }}
    ...
    <script>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status === '500') {
                            alert("{{ __('language.detail_post_alert_like') }}");
        ...
        function formatDate(date) {
            var d = new Date(date);
            return d.getDate() + "/" + String(d.getMonth() + 1).padStart(2, '0') + "/" + d.getFullYear() + " " + d
