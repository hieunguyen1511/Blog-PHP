            ...
            <div class="lg:w-1/4 space-y-0.5">
                ...
                <div class="bg-white shadow-sm overflow-hidden border border-gray-100">
                    ...
                    <div class="p-2">
                        ...
                        class="{{ request()->routeIs('post_notification') ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-600' }} flex items-center px-3 py-2 rounded-md hover:bg-blue-50  transition-colors duration-200">
