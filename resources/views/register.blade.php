    ...
    <div class="bg-white rounded-lg shadow-md p-8 w-full max-w-md">
        ...
        <form class="space-y-4" method="post" action="{{ route('registerUser') }}">
            ...
            <div class="relative">
                ...
                <input type="text" name="fullname" value="{{old(key: 'fullname')}}" required placeholder="{{ __('language.placeholder_fullname') }}" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
            </div>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="mt-6 grid grid-cols-2 gap-3">
            ...
            <button class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-blue-500 hover:bg-gray-50">
