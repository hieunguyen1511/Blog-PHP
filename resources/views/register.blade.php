    ...
    <div class="bg-white rounded-lg shadow-md p-8 w-full max-w-md">
        ...
        <form class="space-y-4" method="post" action="{{ route('registerUser') }}">
            ...
            <div class="relative">
                ...
                <input type="text" name="fullname" value="{{ old(key: 'fullname') }}" required
                    placeholder="{{ __('language.placeholder_fullname') }}"
            ...
            <div class="relative">
                ...
                <input type="email" name="email" value="{{ old('email') }}" required
                    placeholder="{{ __('language.placeholder_email') }}"
                    class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
            </div>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <input type="text" name="username" value="{{ old('username') }}" required
                    placeholder="{{ __('language.placeholder_username') }}"
                    class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
            </div>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            <div class="relative">
                ...
                <input type="password" id="re-password" name="re-password" required
                    placeholder="{{ __('language.placeholder_repassword') }}"
                    class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
            </div>
